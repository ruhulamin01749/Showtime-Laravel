	...
	<div class="container-fluid">
	    <div class="row">
	        <div class="col-md-12" data-select2-id="15">
                ...
                <?php if($title != "Edit-Movie-Category"){ ?>
	                <form class="form-horizontal col-md-6" method="post" action="{{url('/save-movie-category')}}">
	                	@csrf
	                    <div class="card-body">
                ...
                <?php }else{ ?>
                  <form class="form-horizontal col-md-6" method="post" action="{{url('/update-movie-category')}}">
                    @csrf
                      <div class="card-body">
                          ...
                          <div class="form-group row">
                            <div class="col-sm-12">
                                ...
                                <a class="btn btn-info" href="{{URL::to('/manage-movie-category')}}">Cancel</a>
                            </div>
                          </div>
                      </div>
                  </form>
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="{{URL::to('/Edit-Category/'.$category->category_id)}}" class="btn btn-info btn-sm" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                          <a href="{{URL::to('/Delete-Category/'.$category->category_id)}}" class="btn btn-danger btn-sm" title="Delete" onclick="return confirm('Are you Sure about Delete???')"><i class="fa fa-trash"></i> Delete</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
